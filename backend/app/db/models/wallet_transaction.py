...
class WalletTransaction(Base):
    ...
    # Mirrors Expense.due_date / is_paid for Fixed Due transactions so the
    # wallet history screen can show "reserved, due <date>" vs "paid" without
    # a join back to expenses.
