...
class _LoginScreenState extends State<LoginScreen> with TickerProviderStateMixin {
  ...
  // Drives the one-shot welcome sequence: icon pops in, then the wordmark
  // and form card fade/slide in just after.
  ...
  // Drives a slow, looping "breathing" glow behind the icon once the intro
  // has settled — a subtle welcoming pulse rather than a static logo.
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          // Decorative background wash — sits behind everything, never
          // intercepts touches.
          Positioned(
            top: -90,
            right: -70,
              ...
              child: ConstrainedBox(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    // Form now floats as its own card over the gradient
                    // wash instead of sitting flat on the background.
                    SlideTransition(
                      position: _formSlide,
                            ...
                            children: [
                              ...
                              Center(
                                child: TextButton(
                                  ...
                                  style:
                                      TextButton.styleFrom(foregroundColor: _Palette.primaryStart),
                                  child: RichText(
                                    text: const TextSpan(
                                      style: TextStyle(
