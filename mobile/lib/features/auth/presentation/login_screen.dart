...
class _LoginScreenState extends State<LoginScreen> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    // Drives the icon's entrance: it pops in with a slight overshoot, then
    // the wordmark and form fade/slide in just after.
    ...
    // Kick off the intro animation as soon as the screen opens.
      ...
      body: SafeArea(
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              // Animated logo mark — uses the actual app icon asset.
              Center(
              ...
              // Form fields fade + slide in just after the icon settles.
              SlideTransition(
                position: _formSlide,
                child: FadeTransition(
                  opacity: _formFade,
